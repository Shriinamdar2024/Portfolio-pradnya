...
export default function Hero() {
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-20 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-accent-secondary/10 rounded-full blur-[120px] animate-pulse delay-1000" />
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          >
            <a 
              href="#contact" 
              className="px-8 py-4 bg-accent hover:bg-accent/90 text-white rounded-2xl font-bold flex items-center gap-2 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-accent/25"
            >
              Get in Touch
              <Mail size={20} />
            </a>
            <div className="flex gap-3">
              <a href="https://github.com" target="_blank" rel="noreferrer" className="p-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl transition-all hover:-translate-y-1">
                <Github size={24} />
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="p-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl transition-all hover:-translate-y-1">
                <Linkedin size={24} />
              </a>
              <a href="#" className="p-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl transition-all hover:-translate-y-1" title="Download Resume">
                <Download size={24} />
              </a>
            </div>
          </motion.div>
